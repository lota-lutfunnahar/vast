...
public:
  ...
  operator()(generator<table_slice> input, operator_control_plane& ctrl) const
    ...
    source->add_outbound_path(importer, std::make_tuple("import"));
    ...
    // Flush the stream, and then lastly tell the index to flush all events it
    // received. We don't need to do this in a scope guard, as we don't care
    // about flushing if the operator is aborted and this coroutine stops
    // through any means other than rolling off the end.
